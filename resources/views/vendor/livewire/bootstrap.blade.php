            ...
            <ul class="pagination">
                ...
                @else
                    <li class="page-item">
                        ...
                        <a href="#" wire:click="setPage('{{ $paginator->previousPageURL() }}')" rel="prev" aria-label="@lang('pagination.previous')" class="page-link">&lsaquo;</a>
                    </li>
                @endif
                ...
                @if ($paginator->hasMorePages())
                    <li class="page-item">
                        ...
                        <a href="#" rel="next" wire:click="setPage('{{ $paginator->nextPageUrl() }}')" aria-label="@lang('pagination.next')" class="page-link">&rsaquo;</a>
                    </li>
                @else
