                    ...
                    <form class="w3-container first" wire:submit.prevent='registerUser' enctype="multipart/form-data">
                        ...
                        <div class="userInput">
                            <div class="modal-div">
                                ...
                                <input class="modal-input" name="name" type="text" placeholder="Enter fullname" wire:model="name">
                                @error('name')
                            ...
                            <div class="modal-div">
                                ...
                                <input class="modal-input" name="email" type="text" placeholder="Enter email" wire:model="email">
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="modal-div">
                                ...
                                <input class="modal-input" name="password" type="password" placeholder="Enter password" wire:model="password">
                                @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="modal-div">
                                ...
                                <input class="modal-input" name="password_confirmation" type="password" placeholder="Confirm your password" wire:model="password_confirmation">
