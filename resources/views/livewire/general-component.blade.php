                    ...
                    <div class="gl-news-photo1">
                        ...
                        <div class="gl-news-des">
                            ...
                            <p>
                                @if (Auth::check())
                                    {{ Auth::user()->name }} -
                                    {{ Carbon\Carbon::parse($general->created_at)->format(' F d , Y   /   h:i A') }}
                                    <br>
                    ...
                    <div class="single_des">
                        ...
                        @if (Auth::check())
                            <span><strong>{{ Auth::user()->name }}</strong> -
                                {{ Carbon\Carbon::parse($Present->created_at)->format(' F d , Y') }}</span>
                        @endif
            ...
            <div class="first_container first_container_2">
                ...
                @foreach ($restaurant as $Restaurant)
                    ...
                    <div class="single_des">
                        ...
                        @if (Auth::check())
                            <span><strong>{{ Auth::user()->name }}</strong> -
                                {{ Carbon\Carbon::parse($Restaurant->created_at)->format(' F d , Y') }}</span>
                        @endif
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active ">
                            <img src="images/general_images/beach.avif" class="d-block w-100 img_slider"
                                alt="...">
                        </div>
                        <div class="carousel-item ">
                            <img src="images/general_images/fashion.jpg" class="d-block w-100 img_slider"
                                alt="...">
                        </div>
                        <div class="carousel-item ">
                            <img src="images/general_images/travel-02.jpg" class="d-block w-100 img_slider"
                                alt="...">
                        </div>
                    </div>
